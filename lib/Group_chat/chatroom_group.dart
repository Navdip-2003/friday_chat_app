...
class _group_chatroomState extends State<group_chatroom> {
  ...
  List<Map<String, dynamic>> data= [
    ...
    {
      "message":"okk why are you saying ??",
      "sendy":"Navdip",
      "type":"text",
      "time":"03:23 PM"
    },
    {
      "message":"Navdip added pradip",
      "sendy":"Navdip",
      "type":"notify",
      "time":"03:23 PM"
    },
    {
      "message":"https://images.unsplash.com/photo-1666933000035-426a98c3b514?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxMnx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60",
      "sendy":"omsai",
      "type":"img",
      "time":"03:23 PM"
    },
  ...
  Future upload_pickimage() async{
    ...
    await _firestore.collection("groups").doc(group_id).collection("chats").doc(filename).
      set({
    ...
    if(status == 1){
      ...
      await _firestore.collection("groups").doc(group_id).
        collection("chats").doc(filename).update({"message" : image_url});
      print(image_url);
    }
  }
  ...
  Future delete_message() async{
      ...
      for(int i = 0 ; i < mn.length ; i++){
        FirebaseFirestore.instance.collection("last_group").doc(mn[i]["uid"]).collection("group").doc(group_id).set({
          "message" : "${FirebaseAuth.instance.currentUser!.displayName} Deleted All Chat ..",
          "time" : DateTime.now(),
          "group_id" : group_id
        });
      }
      await FirebaseFirestore.instance.collection("groups").doc(group_id).collection("chats").add({
        "message":"${FirebaseAuth.instance.currentUser!.displayName} Deleted All Chat ..",
  ...
  last_message_save(String me) async{
    ...
    for(int i = 0 ; i < mem_list.length ; i++){
      _firestore.collection("last_group").doc(mem_list[i]["uid"]).collection("group").doc(group_id).set({
        "message" : me,
        "time" : DateTime.now(),
        "group_id" : group_id
      });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //         CircleAvatar(
      //           radius: 25,
      //           backgroundImage: group_image == "" ? NetworkImage("https://images.unsplash.com/photo-1666933000035-426a98c3b514?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxMnx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60") : NetworkImage(group_image),
      //         ),
      //         SizedBox(width: rang.size.width /40,),
      //         Container(
      //           width: rang.size.width / 2.35,
      //           child: Text(group_name ,style: TextStyle(
      //             fontFamily: "SansFont" ,
      ...
      //         onSelected: ((value) {
      //           if(value == "profile"){
      //             Navigator.push(context, MaterialPageRoute(builder: (context)=>group_profile(
      //               groupid : group_id ,
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(color: Color.fromARGB(221, 7, 48, 19) , width: 1 ,)
                        ),
                ...
                Flexible(
                  ...
                  child: Container(
                   // margin: EdgeInsets.only(left: rang.size.width / 100),
                    ...
                    }, icon: Icon(Icons.send , size: 30,color: Color.fromARGB(255, 6, 63, 8),)
                  ),
       ...
       floatingActionButton:  SizedBox.fromSize(
         ...
         child: Padding(
           ...
           backgroundColor: Colors.white,
             child: Icon(Icons.arrow_downward_rounded , color: Color.fromARGB(255, 6, 100, 1),),
             onPressed: () {  
              setState(() {
                scrolltobottom();
              });
      ...
      body: WillPopScope(
        onWillPop: () async {
          // Navigator.push(context, MaterialPageRoute(builder: (context)=>contact(i: 1,)));
              widget.i == null ?
              Navigator.pop(context) : Navigator.push(context,MaterialPageRoute(builder: (context)=> navigation() ));
           return false;
            ...
            StreamBuilder(
              ...
              builder:(context, snapshot) {
                if(snapshot.hasData){
                  ...
                  return Container(height: rang.size.height / 9,);
                }
              },
            ),
                ...
                Container(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection("groups").
                      doc(group_id).collection("chats").orderBy("time" , descending: false) .snapshots(),
                                ...
                                children: [
                                  Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  if (snapshot.data!.docs[index]["sendy"] != _auth.currentUser!.displayName) 
                                                    Text("~: "+snapshot.data!.docs[index]["sendy"],style: 
                                                      TextStyle(fontSize: 8 , color: Color.fromARGB(255, 208, 208, 208))),
                                                  Text(snapshot.data!.docs[index]['message'],style: TextStyle(fontSize: 18 , color: Colors.white),),
                                                ],
                                              ),
                                            ),
                                          ...
                                          Container(
                                            ...
                                            width: rang.size.width,
                                            child: Text(dateString,style: TextStyle(fontSize: 9,color: Colors.black45),),
                                          ),
                                          SizedBox(height: 4)
                                ],
                              );
                                  ...
                                  Container(
                                    ...
                                    child: Container(
                                      ...
                                      decoration:  BoxDecoration(
                                        ...
                                        border: Border.all(
                                           color: Color.fromARGB(95, 198, 198, 198),
                                           width: 1.5
                                        ),
                                      ...
                                      child:Text(snapshot.data!.docs[index]['message'],style: TextStyle( 
                                        ...
                                        fontSize: 11 , color: Color.fromARGB(255, 17, 17, 17)),),  
                                    ),
                                  ),
                                  SizedBox(height: 9)      
                                ],
                              ...
                              return Column(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    //color: Colors.blueAccent,
                                    width: rang.size.width,
                                    child: Text(dateString,style: TextStyle(fontSize: 10,color: Colors.black45),),
                                  ),
                                  SizedBox(height: 3)
                                ],
                              ); 
